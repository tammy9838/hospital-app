        ...
        */}
        <View style={styles.button1}>
          ...
          <TouchableOpacity onPress={() =>
            this.props.navigator.push({index:1, passProps:{message:'Your current location'}})}>
            <Text style={{fontSize:15, padding:10, borderWidth:1}}> Routing </Text>
          </TouchableOpacity>
        </View>
